 ...
 * 
 * @see https://tips4java.wordpress.com/2008/11/02/relative-layout/
 */
public class RelativeLayout implements LayoutManager2, java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -596841094319812991L;
	 ...
	 *         specified container
	 * @see redlaboratory.chineseinput.RelativeLayout#minimumLayoutSize
	 ...
	 *         specified container
	 * @see redlaboratory.chineseinput.RelativeLayout#preferredLayoutSize
	...
	private void layoutContainerHorizontally(Container parent) {
		...
		int spaceAvailable = parent.getSize().width - insets.left - insets.right - ((visibleComponents - 1) * gap)
				- (2 * borderGap);
	...
	private void layoutContainerVertically(Container parent) {
		...
		float relativeTotal = 0.0f;
		Insets insets = parent.getInsets();
		int spaceAvailable = parent.getSize().height - insets.top - insets.bottom - ((visibleComponents - 1) * gap)
				- (2 * borderGap);
